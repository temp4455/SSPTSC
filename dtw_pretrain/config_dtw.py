...
def cmd_parameter_fine_tuning():
    ...
    param.similar_path= os.path.join(args.similar_path,os.path.basename(param.data_dir)+'_DTW.npy')
...
#
#     'learning_rate':1e-3,
#     'data_dir':'..//UCRArchive_2018/StarLightCurves',
#     'use_cuda':True,
#     'num_workers':4,
#     'max_epoch':10000,
#     'out_dir':'./out_'+time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())
# })