...
from model_dtw import TSClassifcation,TSEncoder
from model_dtw_longformer import TSClassifcation as LongformerTSClassifcation
...
#         optimizer= optim.Adam(model.parameters(),lr=param.learning_rate,betas=(0.5,0.999),weight_decay=0.01)
    ...
    scheduler= optim.lr_scheduler.ReduceLROnPlateau(optimizer,mode='max',factor=0.5,patience=40,verbose=True,min_lr=1e-6)
