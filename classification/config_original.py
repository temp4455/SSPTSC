...
class Parameter():
    def __init__(self):
        ...
        self.data_dir= '/UCRArchive_2018/StarLightCurves'
        # self.use_cuda= True
...
def cmd_parameter_fine_tuning():
    ...
    # parser.add_argument('--train_num', default=10000, type=int,help='The train size')
    # parser.add_argument('--val_num', default=2000, type=int,help='The train size')
    parser.add_argument('--similar_path',default='/media/***/document/pythonproject/***/DTW_ED/similar_result',type=str,help='the similar path')
    args = parser.parse_args()
    ...
    # param.train_num= args.train_num
    # param.val_num= args.val_num
    param.similar_path= os.path.join(args.similar_path,os.path.basename(param.data_dir)+'_ED.npy')

    # param.seq_len=args.seq_len
    return param


def cmd_parameter_original():
    param = Parameter()
    parser = argparse.ArgumentParser(description='directly the classification!')

    parser.add_argument('--train_batch_size', default=128, type=int, help='the batch size of the input data in training')
    parser.add_argument('--val_batch_size', default=32, type=int, help='the batch size of the input data in val')

    parser.add_argument('--data_dir',
                        default='/media/***/externdisk/python_workspace/***/UCRArchive_2018/', type=str,
                        help='the path for input data')
    parser.add_argument('--model_path',default='',type=str,help='the path of the pre train model ')
    # parser.add_argument('--use_cuda', default=1, type=int, help='1 define True, 0 define False, default 1')
    parser.add_argument('--start_cuda_id', default=0, type=int, help='the start id of gpu')
